...
/**
 * AbstractPostgresTaskEntityJdbcRepository
 *
 * @author Jerry.X.He
 * @version 1.0
 * @date 2021-02-02 19:10
 */
public abstract class AbstractPostgresTaskEntityJdbcRepository<T> extends AbstractPostgresEntityJdbcRepository<T>
