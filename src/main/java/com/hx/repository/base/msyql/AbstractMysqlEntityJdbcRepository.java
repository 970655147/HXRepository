package com.hx.repository.base.msyql;
...
import com.hx.repository.utils.*;
...
/**
 * AbstractMysqlEntityJdbcRepository
 *
 * @author Jerry.X.He
 * @version 1.0
 * @date 2021-02-02 19:10
 */
public abstract class AbstractMysqlEntityJdbcRepository<T> extends AbstractEntityJdbcRepository<T> {
    ...
    protected String wrapFieldValueSql(Object fieldValueObj, FieldInfo fieldInfo) {
        if (ClassUtils.isBooleanClass(fieldInfo.getField().getType())) {
            return (fieldValueObj == null) ? "null" : String.valueOf(fieldValueObj);
        }
