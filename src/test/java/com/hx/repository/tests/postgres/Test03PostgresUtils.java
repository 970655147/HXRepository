...
public class Test03PostgresUtils extends PostgresBaseRepositoryTest {

    /** BASE_PATH */
    private static String BASE_PATH = System.getProperty("user.dir");
    /** BASE_IGNORE_PATH */
    private static String BASE_IGNORE_PATH = BASE_PATH + "/src/test/java/com/hx/repository/tests/postgres/ignore";

    @Test
    public void test01TradeSchemaWithFakePath() {
        Class<Trade> clazz = Trade.class;
        String filePath = "fakepath";
        List<String> lines = PostgresUtils.generateTableSchema(clazz, filePath);

        String createTableSignature = PostgresUtils.generateCreateTableSignature(clazz);
