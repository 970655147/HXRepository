...
public class Test03SqliteUtils extends BaseServiceTest {
    ...
    /** BASE_IGNORE_PATH */
    private static String BASE_IGNORE_PATH = BASE_PATH + "/src/test/java/com/hx/repository/tests/sqlite/ignore";
    ...
    public void test01TradeSchemaWithFakePath() {
        ...
        String createTableSignature = SqliteUtils.generateCreateTableSignature(clazz);
